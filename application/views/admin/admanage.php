           ...
           /* $(function() {
			...
			$(document).ready(function() {
				...
				$('#sub').click(function(){
					...
					'bPaginate': true,
				    "bDeferRender": true,
					"sAjaxSource": "<?php echo base_url('admin/admanage/pagingadmanage/'); ?>",
					"language": {            
                        //"sSearch": "",
					...
					if($('#add').val()==0){
					$("#sample_2_wrapper .col-md-6").first().html('<button class="btn btn-success" id="sample_editable_1_new" >Add Ads <i class="fa fa-plus"></i></button>');
					}else{
					...
					$('#sample_editable_1_new').click(function(){
										...
										//alert('aaaaaaa');
										window.location="<?php echo base_url('admin/admanage/addadmanage'); ?>"
		...
		<div class="page-content" style="box-shadow:#666 0 2px 5px inset;">
			...
			<div class="page-bar braf_shadow">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?php echo base_url(); ?>admin/admanage">Ad Manage</a>
						<i class="fa fa-angle-right"></i>					</li>
					<li>
				...
				<div class="col-md-12">
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>List Ads 
							</div>
							<div class="tools">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <td width="49%" ><strong>Title</strong></td>
												 <td width="16%" align="center"><strong>Start Date</strong></td>
												<td width="16%"  align="center" ><strong>End Date</strong></td>
