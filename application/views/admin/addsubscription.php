				...
				<div class="col-md-12 ">
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">Add Subscription
						...
						<div class="portlet-body form">
							       <form name="formSubscription" class="form-horizontal" id="formSubscription" method="post" action="<?php  echo base_url('admin/subscription/addsubscription'); ?>" >
								   	<div class="form-body">
									   <div class="form-group" >
                                            <label class="col-md-2 control-label" for="exampleInputEmail1">Add Name</label>
                                            <div class="col-md-4">
											<input type="text" name="name" id="name"  class="form-control"  value=""/>
                                            </div>
                                       </div>
									   <div class="form-group" >
                                            <label class="col-md-2 control-label" for="exampleInputEmail1">Add Payment Type</label>
                                            <div class="col-md-4">
											<input type="text" name="type" id="type"  class="form-control"  value=""/>
                                            </div>
                                       </div>
									   <div class="form-group" >
                                            <label class="col-md-2 control-label" for="exampleInputEmail1">Add Description</label>
                                            <div class="col-md-4">
											<input type="text" name="description" id="description"  class="form-control"  value=""/>
                                            </div>
                                       </div>
									   <div class="form-group" >
                                            <label class="col-md-2 control-label" for="exampleInputEmail1">Add Cost ($)</label>
                                            <div class="col-md-4">
