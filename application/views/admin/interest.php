           ...
           /* $(function() {
			...
			$(document).ready(function() {
				...
				$('#sub').click(function(){
					...
					'bPaginate': true,
				    "bDeferRender": true,
					"sAjaxSource": "<?php echo base_url('admin/interest/paginginterest/'); ?>",
					"language": {            
                        //"sSearch": "",
...
function showsubinterest(interestID){
							...
							$.post('http://grid.digiopia.in/admin/interest/showsubinterest', the_data).done(function(sp_response) {
								//$('#sp_likebox' + eventID).html(sp_response);
								//alert(sp_response);
								$('#cboxLoadedContent').append(sp_response);
							 });
						
							//$('#sp_likebox' + eventID).show();
							//$(this).colorbox({initialWidth:'760px', initialHeight:'480px', width:'760px', height:'480px', overlayClose:true, inline:true, href: '#sp_likebox' + eenvtID, title: 'List of SubDomain'});
							   $(".ajax").colorbox({initialWidth:'760px', initialHeight:'480px', width:'760', height:'480', overlayClose:true, inline:true, title: 'List of SubInterest'});							   
							   $(".ajax").colorbox({
									onCleanup:function(e){
										//$('#sp_likebox' + eventID).hide();
		...
		<div class="page-content" style="box-shadow:#666 0 2px 5px inset;">
			...
			<div class="page-bar braf_shadow">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?php echo base_url(); ?>admin/interest">Interest</a>
						<i class="fa fa-angle-right"></i>					</li>
					<li>

						<a href="#">List Interest </a>
						<!--<i class="fa fa-angle-right"></i>-->					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>List Interest 
							</div>
							<div class="tools">
							...
							<table id="sample_2" class="table table-bordered table-striped gradient_row" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <td width="58%" ><strong>Interest name</strong></td>
												 <td width="15%" align="center"><strong>Sub Interest</strong></td>
