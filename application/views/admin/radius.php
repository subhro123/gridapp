           ...
           /* $(function() {
			...
			$(document).ready(function() {
				...
				$('#sub').click(function(){
					...
					'bPaginate': true,
				    "bDeferRender": true,
					"sAjaxSource": "<?php echo base_url('admin/radius/pagingradius/'); ?>",
					"language": {            
                        //"sSearch": "",
					...
					if($('#add').val()==0){
					$("#sample_2_wrapper .col-md-6").first().html('<button class="btn btn-success" id="sample_editable_1_new" >Add Radius <i class="fa fa-plus"></i></button>');
					}else{
					...
					$('#sample_editable_1_new').click(function(){
										...
										//alert('aaaaaaa');
										window.location="<?php echo base_url('admin/radius/addradius'); ?>"
		...
		<div class="page-content" style="box-shadow:#666 0 2px 5px inset;">
			...
			<div class="page-bar braf_shadow">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?php echo base_url(); ?>admin/interest">Radius</a>
						<i class="fa fa-angle-right"></i>					</li>
					<li>

						<a href="#">List Radius</a>
						<!--<i class="fa fa-angle-right"></i>-->					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>List Radius 
							</div>
							<div class="tools">
							...
							<table id="sample_2" class="table table-bordered table-striped gradient_row" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <td width="46%" ><strong>User Type</strong></td>
												 <td width="14%" align="center"><strong>Min</strong></td>
												<td width="13%"  align="center" ><strong>Max</strong></td>
