				...
				<div class="col-md-12 ">
					...
					<div class="portlet">
						...
						<div class="portlet-body form">
							       <form name="formInterest" class="form-horizontal" id="formInterest" method="post" action="<?php  echo base_url('admin/radius/addradius'); ?>"  onsubmit="return validate()" >
								   	<div class="form-body">
                                            ...
                                            <label class="col-md-2 control-label" for="exampleInputEmail1">Select  User Type</label>
													...
													<div class="radio-list">
														<label class="radio-inline">
															<input type="radio" name="user_type" value="free" id="free" >&nbsp;Free
														</label>
														<label class="radio-inline">
															<input type="radio" name="user_type" value="paid"  id="paid">&nbsp;Paid
														</label>
											   		</div>
												</div>
                                            
                                      </div>
									  <div class="form-group" style="display:none;" id="mindiv">
                                            <label class="col-md-2 control-label" for="exampleInputEmail1">Add min value</label>
                                            <div class="col-md-4">
									   ...
									   <div class="form-group" style="display:none;" id="maxdiv">
                                            <label class="col-md-2 control-label" for="exampleInputEmail1">Add max value</label>
                                            <div class="col-md-4">
											<input type="text" name="max" id="max"  class="form-control"  value=""/>
                                            </div>
                                       </div>
									   <div class="form-group" >
