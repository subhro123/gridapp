           ...
           /* $(function() {
			...
			$(document).ready(function() {
				...
				$('#sub').click(function(){
					...
					'bPaginate': true,
				    "bDeferRender": true,
					"sAjaxSource": "<?php echo base_url('admin/subscription/pagingsubscription/'); ?>",
					"language": {            
                        //"sSearch": "",
...
function updateStatus(id){
	...
	$.ajax({
                type:'POST',
                url:'<?php echo base_url(); ?>admin/subscription/isactivecheck',
		        data:{id:id,val:val},
                dataType:'json',
		...
		<div class="page-content" style="box-shadow:#666 0 2px 5px inset;">
			...
			<div class="page-bar braf_shadow">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?php echo base_url(); ?>admin/interest">Subscription</a>
						<i class="fa fa-angle-right"></i>					</li>
					<li>
				...
				<div class="col-md-12">
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>List Subscription 
							</div>
							<div class="tools">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <td width="26%" ><strong>Name</strong></td>
												 <td width="16%" align="center"><strong>Cost ($)</strong></td>
